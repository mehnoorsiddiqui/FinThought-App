...
# VOAI Report Income Stream Record
...
| `transactions` | [`VOAIReportTransactionsForIncomeStreams[]`](../../doc/models/voai-report-transactions-for-income-streams.md) | Required | A list of transaction records |
