...
} from './payrollReportData';
import {
  ReportCustomField,
  reportCustomFieldSchema,
} from './reportCustomField';

export interface PayrollReportRefreshResponseConstraints {
...
export const payrollReportRefreshResponseConstraintsSchema: Schema<PayrollReportRefreshResponseConstraints> = expandoObject(
  {
    payrollData: ['payrollData', lazy(() => payrollReportDataSchema)],
    reportCustomFields: [
      'reportCustomFields',
