...
export interface GeneratePrequalificationReportCRAResponse {
...
export const generatePrequalificationReportCRAResponseSchema: Schema<GeneratePrequalificationReportCRAResponse> = expandoObject(
  {
    id: ['id', string()],
