...
export interface PayrollReportRefreshConstraints {
  payrollData: PayrollResponseData;
...
export const payrollReportRefreshConstraintsSchema: Schema<PayrollReportRefreshConstraints> = expandoObject(
  {
    payrollData: ['payrollData', lazy(() => payrollResponseDataSchema)],
    reportCustomFields: [
      'reportCustomFields',
