...
export interface GenerateConnectURLRequestDataAndPayments {
  ...
  /** ID of the specific Institution login flow to present to the Customer/Consumer. For type "aggregation" this will present this institution by default as the first institution to add and then the customer can move on to other institutions to add after. */
...
export const generateConnectURLRequestDataAndPaymentsSchema: Schema<GenerateConnectURLRequestDataAndPayments> = expandoObject(
  {
