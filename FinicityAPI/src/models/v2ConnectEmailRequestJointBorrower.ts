...
import { Borrowers, borrowersSchema } from './borrowers';
import {
...
export interface V2ConnectEmailRequestJointBorrower {
  ...
  borrowers: Borrowers[];
  /** The URL that customers are redirected after they complete the Connect application.  If this parameter isn’t specified, then a thank you screen appears and the customer ends Connect. */
  redirectUri?: string;
  /** The URL used to send notifications about events as the user interacts with screens throughout the Connect application. See [Connect Webhooks]( https://docs.finicity.com/connect-webhooks/) */
  webhook?: string;
  /** The content type that the webhook events are sent. */
  webhookContentType?: string;
  /** Allows you to insert additional information into the Connect webhook events payload. See [Connect Custom Webhooks Data and Headers]( https://docs.finicity.com/connect-custom-webhook-data-and-headers/) */
  webhookData?: unknown;
  /** Allows you to include header information for the Connect webhook events. See [Connect Custom Webhooks Data and Headers]( https://docs.finicity.com/connect-custom-webhook-data-and-headers/) */
  webhookHeaders?: unknown;
  /** Advanced configuration options to display institutions. See [Institution Settings](https://docs-new.finicitydev.com/connect-institutions-options/) */
  institutionSettings?: unknown;
  /** The configuration email details. */
  email: ConnectV2EmailOptions;
...
export const v2ConnectEmailRequestJointBorrowerSchema: Schema<V2ConnectEmailRequestJointBorrower> = expandoObject(
  {
    partnerId: ['partnerId', string()],
    borrowers: ['borrowers', array(lazy(() => borrowersSchema))],
    ...
    email: ['email', lazy(() => connectV2EmailOptionsSchema)],
    ...
    optionalConsumerInfo: [
      'optionalConsumerInfo',
      lazy(() => optionalConsumerInformationSchema),
    ],
  }
);
