...
export interface GenerateConnectURLRequestLending {
  ...
  /** ID of the specific Institution login flow to present to the Customer/Consumer. For any lending and report type flow this will present this institution first to the customer to add and then they may add additional institutions after this first default one. */
...
export const generateConnectURLRequestLendingSchema: Schema<GenerateConnectURLRequestLending> = expandoObject(
  {
