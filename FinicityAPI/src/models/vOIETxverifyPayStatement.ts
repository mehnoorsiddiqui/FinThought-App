...
import {
  ...
  payStatementMatchTypesEnumSchema,
} from './payStatementMatchTypesEnum';
import {
...
import {
  ...
  vOIETxverifyReportPayStatementsInstitutionSchema,
} from './vOIETxverifyReportPayStatementsInstitution';

export interface VOIETxverifyPayStatement {
  ...
  matchType: PayStatementMatchTypesEnum;
  ...
  /** Details of the financial institution accounts and income streams with matching transactions to the pay statement. */
  institutions: VOIETxverifyReportPayStatementsInstitution[];
...
export const vOIETxverifyPayStatementSchema: Schema<VOIETxverifyPayStatement> = expandoObject(
  {
    ...
    matchType: ['matchType', payStatementMatchTypesEnumSchema],
    ...
    institutions: [
      'institutions',
      array(lazy(() => vOIETxverifyReportPayStatementsInstitutionSchema)),
    ],
