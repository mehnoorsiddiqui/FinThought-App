...
export interface ReportIncomeStreamRecord {
  ...
  transactions: VOIReportTransactionRecord[];
  [key: string]: unknown;
}

export const reportIncomeStreamRecordSchema: Schema<ReportIncomeStreamRecord> = expandoObject(
  {
    id: ['id', string()],
    name: ['name', string()],
