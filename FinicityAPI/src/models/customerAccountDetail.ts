...
export interface CustomerAccountDetail {
  ...
  loanStatus?: string;
  /** (Student Loan) The start date of the current status */
  loanStatusStartDate?: bigint;
  /** (Student Loan) The end date of the current status */
  ...
  /** (Student Loan) The start date of the current repayment plan */
  repaymentPlanStartDate?: bigint;
  /** (Student Loan) The end date of the current repayment plan */
...
export const customerAccountDetailSchema: Schema<CustomerAccountDetail> = expandoObject(
  {
    ...
    autoPayEnrolled: ['autoPayEnrolled', optional(boolean())],
    ...
    firstMortgage: ['firstMortgage', optional(boolean())],
