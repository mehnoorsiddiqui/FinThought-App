...
export interface GenerateV2ConnectURLRequestJointBorrower {
...
export const generateV2ConnectURLRequestJointBorrowerSchema: Schema<GenerateV2ConnectURLRequestJointBorrower> = expandoObject(
  {
