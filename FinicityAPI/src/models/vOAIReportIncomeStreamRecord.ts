...
import {
  ...
  vOAIReportTransactionsForIncomeStreamsSchema,
} from './vOAIReportTransactionsForIncomeStreams';

/** Report Income Stream Record */
export interface VOAIReportIncomeStreamRecord {
  ...
  transactions: VOAIReportTransactionsForIncomeStreams[];
  [key: string]: unknown;
}

export const vOAIReportIncomeStreamRecordSchema: Schema<VOAIReportIncomeStreamRecord> = expandoObject(
  {
    id: ['id', string()],
    name: ['name', string()],
    ...
    transactions: [
      'transactions',
      array(lazy(() => vOAIReportTransactionsForIncomeStreamsSchema)),
    ],
  }
);
