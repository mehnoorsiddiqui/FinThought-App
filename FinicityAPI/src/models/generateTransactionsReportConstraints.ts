...
export interface GenerateTransactionsReportConstraints {
  /** Specific accountIds to be included in the new report. If left blank, all accounts associated with the Customer ID will be included. */
  accountIds?: string;
...
export const generateTransactionsReportConstraintsSchema: Schema<GenerateTransactionsReportConstraints> = expandoObject(
  {
