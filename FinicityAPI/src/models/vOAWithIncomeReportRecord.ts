...
import {
  ...
  vOAWithIncomeReportInstitutionSchema,
} from './vOAWithIncomeReportInstitution';

/** VOA with Income Report Record */
export interface VOAWithIncomeReportRecord {
  ...
  institutions: VOAWithIncomeReportInstitution[];
  assets: PrequalificationReportAssetSummary;
  [key: string]: unknown;
}

export const vOAWithIncomeReportRecordSchema: Schema<VOAWithIncomeReportRecord> = expandoObject(
  {
    id: ['id', string()],
    ...
    institutions: [
      'institutions',
      array(lazy(() => vOAWithIncomeReportInstitutionSchema)),
    ],
