...
export interface GeneratePayStatementReportResponse {
...
export const generatePayStatementReportResponseSchema: Schema<GeneratePayStatementReportResponse> = expandoObject(
  {
    id: ['id', string()],
