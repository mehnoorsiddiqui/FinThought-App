...
import {
  ...
  vOAReportTransactionSchema,
} from './vOAReportTransaction';
...
export interface VOAReportAccount {
  ...
  transactions: VOAReportTransaction[];
...
export const vOAReportAccountSchema: Schema<VOAReportAccount> = expandoObject({
  id: ['id', bigint()],
  ...
  transactions: ['transactions', array(lazy(() => vOAReportTransactionSchema))],
