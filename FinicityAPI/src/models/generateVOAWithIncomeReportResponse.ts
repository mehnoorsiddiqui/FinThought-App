...
export interface GenerateVOAWithIncomeReportResponse {
...
export const generateVOAWithIncomeReportResponseSchema: Schema<GenerateVOAWithIncomeReportResponse> = expandoObject(
  {
    id: ['id', string()],
