...
export interface VOIETxverifyReportTransactionForPayStatements {
...
export const vOIETxverifyReportTransactionForPayStatementsSchema: Schema<VOIETxverifyReportTransactionForPayStatements> = expandoObject(
  {
    id: ['id', bigint()],
    ...
    payStatementMatchTypes: [
      'payStatementMatchTypes',
      array(reportTransactionPayStatementMatchTypesEnumSchema),
    ],
  }
);
