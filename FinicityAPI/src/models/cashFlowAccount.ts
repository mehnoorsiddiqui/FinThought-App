...
export const cashFlowAccountSchema: Schema<CashFlowAccount> = expandoObject({
  id: ['id', string()],
  ...
  transactions: ['transactions', array(lazy(() => cashFlowTransactionsSchema))],
  cashFlowBalance: [
    'cashFlowBalance',
    lazy(() => cashFlowCashflowBalanceSchema),
  ],
  cashFlowCredit: ['cashFlowCredit', lazy(() => cashFlowCashFlowCreditSchema)],
  cashFlowDebit: ['cashFlowDebit', lazy(() => cashFlowCashflowDebitSchema)],
  cashFlowCharacteristic: [
    'cashFlowCharacteristic',
    lazy(() => cashFlowCashflowCharacteristicSchema),
  ],
});
