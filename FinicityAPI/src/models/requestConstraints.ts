...
export interface RequestConstraints {
  ...
  accountIds?: string;
  /** Include income streams in the report, based on the income stream’s confidence score. <br> <br> **Example**: Use the value: 50 to include only income streams with a confidence score of 50 or higher. */
...
export const requestConstraintsSchema: Schema<RequestConstraints> = expandoObject(
  {
