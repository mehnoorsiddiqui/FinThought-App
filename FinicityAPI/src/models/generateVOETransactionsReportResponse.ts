...
export interface GenerateVOETransactionsReportResponse {
...
export const generateVOETransactionsReportResponseSchema: Schema<GenerateVOETransactionsReportResponse> = expandoObject(
  {
    id: ['id', string()],
