...
export interface GenerateV2ConnectEmailRequest {
  /** Your partner id from the [Finicity Developer Portal](https://signup.finicity.com/). */
  partnerId: string;
  /** The customerID from the Add Customer call. */
  customerId: string;
  /** The consumerID from the Create Customer call. <br> Note: Required for any connect type that generates a report. */
  consumerId: string;
...
export const generateV2ConnectEmailRequestSchema: Schema<GenerateV2ConnectEmailRequest> = expandoObject(
  {
